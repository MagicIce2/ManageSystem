...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${pageContext.request.contextPath}/jsp/pay.action" method=post>
		...
		<form name=traderefund action="${pageContext.request.contextPath}/jsp/refund" method=post
              target="_blank">
