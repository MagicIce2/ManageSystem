...
<div class="container">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/jsp/signInfo.action" method="post" name="form1" onsubmit="return checkinfo()">
    ...
    <c:if test="${not empty sessionScope.stuName && not empty sessionScope.stuClass}">
        <%request.getRequestDispatcher("${pageContext.request.contextPath}/jsp/success.jsp").forward(request, response);%>
    </c:if>
</div>
