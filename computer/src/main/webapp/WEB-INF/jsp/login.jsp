...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-14" data-genuitec-path="/firstweb/WebRoot/login.jsp">
  	...
  	<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-14" data-genuitec-path="/firstweb/WebRoot/login.jsp">
        <div><h3>${sessionScope.msg}</h3></div>
    <form class="form-horizontal col-md-offset-4 col-md-4" action="${pageContext.request.contextPath}/jsp/member_signin.action" method="post" name="form_login" onsubmit="return checkinfo_login()">
		    <div class="form-group">
		    	<label for="No" class="col-sm-2 control-label">账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号</label>
		    	<div class="col-sm-10">
		    		<input type="text" class="form-control" id="No" placeholder="请输入账号" name="stuNo" onblur="checkedNo()">
		    	</div>
		    </div>
		    ...
		    <div class="form-group">
		    	...
		    	<div class="col-sm-10">
		    		<input type="password" class="form-control" id="pass" placeholder="请输入密码" name="stuPassword">
		    	</div>
		    </div>
		    <div class="form-group">
