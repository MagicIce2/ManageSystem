...
<body style="background-color:#eee;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/firstweb/WebRoot/index.jsp">
<%@ include file="header.jsp"%>
<div style="background:url(img/huiheng.jpg) repeat-x;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/firstweb/WebRoot/index.jsp">
    <div style="background:url(img/huiheng.jpg) repeat-x;margin-top:-20px;" class="hidden-xs container" >
        <img src="img/banner.jpg" class="img-rounded img-responsive">
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="alert alert-info">
                    <h3>前沿科技</h3>
                    <p>
                        大数据，云计算，区块链，人工智能，物联网最近几年很火，会有专门的人才向大家讲解现在技术的发展方向，将迷茫的你带回正轨，当然中间可以观看电影，让你看到未来的技术，说不定下一个工业革命就是因为你。
                    </p>
                </div>
            </div>
        </div>
