<%@ page import="com.ComputerSociety.Domain.Member" %>
...
<div class="container">
    <div class="row">
        <form action="query.cm" method="post">
    ...
    <table class="table table-bordered table-responsive">
        <tr><td colspan="12" align="center">社团注册成员为${requestScope.size}人</td></tr>
        <tr>
            <th>序号</th>
            <th>学院</th>
            <th>班级</th>
    ...
    <c:forEach items="${ requestScope.members}" var="member">
        <tr>
            ...
            <td>${member.money}</td>
            <td><a href="edit.cm?id=${member.id}">修改</a></td>
...
<script type="text/javascript">
    function delete_data(obj){
        ...
        if (x(obj)){
            ...
            xmlHttp.open("GET", "delete.cm?id=" + id, true);
    ...
    $('#js-export').click(function(){
        window.location.href="exportExcel.cm";
    });
</script>
</body>
</html>
