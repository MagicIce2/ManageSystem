package com.SignSystem.servlet;

import com.SignSystem.dao.Impl.StudentDAOkdbcImpl;
    ...
    private void append(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(stuName != null && !stuName.equals("")) {
            ...
            if (count > 0) {
                ...
                request.getRequestDispatcher("SignSystem.jsp").forward(request, response);
                return;
            }
...
//        response.addCookie(cookieName);
            ...
            response.sendRedirect("SignSystem.jsp");
        }
    }
    ...
    private void exportData(HttpServletResponse response, String stuDepart, String title, String head, String tile) throws IOException {
        ...
        String fileName = stuDepart + ".docx";
        ...
        String buf = title + head + stuDepart + Information + tile;
